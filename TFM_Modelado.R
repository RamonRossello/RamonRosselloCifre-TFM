...
# Selección de hiperparámetros y obtención de modelo final
# De cada modelo se obtiene su valor medio de MAE (respecto conjuntos de 
# entrenamiento y de validación) y su valor medio de R^2.
...
# El AIC crece si se elimina alguna variable.
library(MASS)
stepAIC(mg_full)

# No se elimina ningún parámetro. 

# Validez y evaluación del modelo
...
# Capacidad predictiva real del modelo
...
# Efecto de cada variable de entrada
